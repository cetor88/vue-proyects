        ...
        <v-layout row>
            <v-flex xs4>
                <v-layout row>
                    <v-flex>
                        <v-text-field
                            label="Titulo" v-model="titulo" required >
                        </v-text-field>
                    </v-flex>
                </v-layout row>
            </v-flex xs4>
            <v-flex xs4>
                <v-layout row>
                    <v-text-field name="contenido" rows="2" label="Contenido" multi-line maxlength="100"></v-text-field>
                </v-layout row>
            </v-flex  xs4>
                <v-btn class="pink accent-4" dark>Continuar</v-btn>
            </v-flex>
        </v-layout>
        ...
        <v-layout row>
            <v-flex xs6>
                <div v-for="item in catImges">
                    <img v-bind:src="item.imagen" width="50px" height="30px"/>
                    <v-divider inset></v-divider>
                </div> 
            </v-flex>
            <v-flex xs6>
                <v-subheader v-text="'Autocomplete'"></v-subheader>
                <v-select v-bind:items="states" v-model="a1" label="Select"
                    autocomplete >
                </v-select>    
            </v-flex>
        </v-layout row>    
