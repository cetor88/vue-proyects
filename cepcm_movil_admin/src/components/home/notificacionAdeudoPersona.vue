        ...
        <v-container grid-list-md text-xs-center>
            ...
            <v-layout row wrap>
                <v-flex sm8 offset-sm2>
                    <v-layout row wrap>
                        <v-flex sm3 xs12>
                            <v-subheader class="text-sm-center"> Plantel:</v-subheader>
                        </v-flex>
                        <v-flex sm9 xs12>
            ...
            <v-layout row wrap>
                <v-flex sm8 offset-sm2>
                    ...
                    <v-layout row wrap>
                        <v-flex sm3 xs12>
                            <v-subheader class="text-sm-center">Nivel academico:</v-subheader>
                        </v-flex>
                        <v-flex sm9 xs12>
            ...
            <v-layout row wrap>
                <v-flex sm8 xs6 offset-sm3>
                    ...
                    <v-btn d-inline-flex :loading="loading3" color="primary" @click="generarReporte" :disabled="items.length==0">
                        Generar reporte
            ...
            <v-layout row wrap>
                <v-flex md12 hidden-sm-and-down class="contenedorTabla">
                        ...
                        <template slot="items" slot-scope="props">
                            <tr :active="props.selected" @click="cambio( props)">
                                ...
                                <td class="text-xs-center">
                                    ...
                                    <v-icon v-if="props.item.alumno.dispositivo != null" color="green"> phonelink_ring
                                    </v-icon>
                                    <v-icon v-if="props.item.alumno.dispositivo == null" color="red"> phonelink_erase
                                    </v-icon>
                                </td>
                                <td class="text-xs-center"> {{ props.item.alumno.matricula }} </td>
                                <td class="text-xs-center"> {{ props.item.alumno.nombres + " "+
                                    props.item.alumno.apaterno + " " + props.item.alumno.amaterno}} </td>
                                <td class="text-xs-center"> {{ props.item.colegiaturasAdeudadas }} </td>
                                <td class="text-xs-center"> {{ props.item.recargos }} </td>
                                <td class="text-xs-center"> {{ parseInt(props.item.importeRecargosColegiaturas * 100) /
                                    100 | pesos}} </td>
                                <td class="text-xs-center"> {{ parseInt(props.item.importeColegiaturas * 100) / 100 |
                                    pesos}} </td>
                                <td class="text-xs-center"> {{ props.item.reinscripcionesAdeudadas }} </td>
                                <td class="text-xs-center"> {{ parseInt(props.item.importeReinscripciones * 100) / 100
                                    | pesos}} </td>
                                <td class="text-xs-center"> {{ parseInt(props.item.adeudoTotal * 100) / 100 | pesos}}
                                </td>
                            </tr>
                        </template>
